/**
 * @module
 * @desc Controllers for the Media Entertain Core (MEC) routes
 */
 ...
 * @param res {object} - The express response object
 */
async function mecPutResource(req, res) {
 ...
 * @param res {object} - The express response object
 */
async function mecDeleteResource(req, res) {
 ...
 * @param res {object} - The express response object
 */
async function mecPostResource(req, res) {
